...
export const DirectionAwareHover = ({
  ...
  return (
    <motion.div
      ...
      ref={ref}
      className={cn(
        "w-full max-w-3xl aspect-video bg-transparent rounded-lg overflow-hidden group/card relative",
        className
      )}
    >
      <AnimatePresence mode="wait">
        <motion.div
          ...
          <motion.div
            ...
            <img
              alt="image"
              className={cn("h-full w-full object-contain scale-[1.15]", imageClassName)}
              width="1000"
              height="1000"
              src={imageUrl} />
          </motion.div>
