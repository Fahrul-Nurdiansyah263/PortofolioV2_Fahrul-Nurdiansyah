...
const Threads = ({ color = [1, 1, 1], amplitude = 1, distance = 0, enableMouseInteraction = false, ...rest }) => {
  ...
  useEffect(() => {
    ...
    // Resolusi render dicap lebih rendah + dpr dibatasi ke 1 karena ini cuma
    // dekorasi background, bukan konten utama. Turunkan MAX_RENDER_DIM lagi
    // (mis. 960) kalau masih berat di device rendah.
    ...
    // Throttle ke ~30fps — shader sekelas ini nggak butuh 60fps buat kelihatan halus,
    // dan ini langsung motong beban GPU hampir setengahnya.
    const TARGET_FPS = 30;
